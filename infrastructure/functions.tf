...
resource "azurerm_linux_function_app" "llm-analyzer-function" {
  ...
  app_settings = {
    ...
    "LLM_ANALYZER_FOUNDRY_ENDPOINT"                                            = "https://${azurerm_cognitive_account.account_llm.custom_subdomain_name}.openai.azure.com"
    "LLM_ANALYZER_FOUNDRY_DEPLOYMENT_NAME"                                     = azurerm_cognitive_account.account_llm.name
  }
}
